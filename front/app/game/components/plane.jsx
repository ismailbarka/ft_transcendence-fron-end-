...
const Plane = () => {
  ...
  const materials = [
    ...
    new THREE.MeshStandardMaterial({map: outsideTex, side: THREE.BackSide}), // top
    new THREE.MeshStandardMaterial({map: insideTex, side: THREE.BackSide}), // bottom
    new THREE.MeshStandardMaterial({transparent: true, opacity: 0, side: THREE.DoubleSide}), // front
  ...
  return (
    <group>
      ...
      <mesh position={[0,0,0]} ref={meshRef} material={materials}>
      ...
      <lineSegments>
        ...
        <lineBasicMaterial attach="material" color="#fff" /> {/*change the color for the line segments of the box*/}
      </lineSegments>
    </group>
  );
};
